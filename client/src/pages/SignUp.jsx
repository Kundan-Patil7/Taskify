    ...
    <div className='min-h-screen flex items-center justify-center p-4 bg-gray-50'>
      ...
      <div className='w-full max-w-md bg-white p-8 rounded-lg shadow-md border border-gray-200 z-10'>
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          <div>
            <input
              ...
              className={`${authStyles.input} ${errors.name ? 'border-red-500' : ''}`}
          ...
          <div>
            <input
              ...
              onChange={handleChange}
              className={`${authStyles.input} ${errors.confirmPassword ? 'border-red-500' : ''}`}
        ...
        <p className='text-center text-sm text-gray-600 mt-4'>
          ...
          <NavLink to="/login" className={authStyles.link}>
            Login
          </NavLink>
        </p>
      </div>
